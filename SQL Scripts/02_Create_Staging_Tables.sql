...
CREATE TABLE staging.StudentMaster (
...
CREATE TABLE staging.StudentEnrollment (
...
CREATE TABLE staging.AcademicPerformance (
...
CREATE TABLE staging.FinancialAid (
    AidID          VARCHAR(20),
    StudentID      VARCHAR(20),
    AcademicYear   VARCHAR(10),
    AidType        VARCHAR(30),
...
CREATE TABLE staging.StudentAttendance (
